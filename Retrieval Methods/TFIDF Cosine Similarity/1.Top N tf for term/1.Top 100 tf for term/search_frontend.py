...
with open("postings_gcp_body_sample/index.pkl", 'rb') as f:
    index_body_sample = pickle.load(f)
...
def search():
    ...
    # TFIDF Cos sim calc
    q_vec = generate_query_tfidf_vector(tokens, index_body_sample)
    tfidf = generate_document_tfidf_matrix(tokens, index_body_sample)
